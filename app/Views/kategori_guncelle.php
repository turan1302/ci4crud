...
<body>
  ...
  <div class="container">
    ...
    <form method="POST" action='<?php echo base_url("kategoriler-guncelle/{$kategori['id']}"); ?>'>
      <div class="form-group">
        <label for="usr">Kategori Adı:</label>
        <input type="text" name="title" class="form-control" id="usr" required="" value="<?php echo $kategori['title']; ?>" placeholder="Kategori Adını Giriniz">
      </div>
